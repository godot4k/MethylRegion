...
AMRfinder <- function(intput_dat, y, cov.mod = NULL, controlist = list(
  ...
  colnames(nfo$outputList)[-4] <- c("chr", "start", "end", "N.CpGs", "cor_est", "coef_meth", "p_value", "methX", "methY")
